...
import { checkComment, checkCreateImg, handleUploadImage, middleToken } from "../middlewares/authMiddleware.js";
import {
  addComment,
  checkSavedImage,
  createImage,
...
//Create image
imgRouter.post("/create-img",middleToken,handleUploadImage('hinhAnh'),checkCreateImg,createImage)
